...
namespace s3cr3tx.Controllers
{
    ...
    public class ValuesController : ControllerBase
    {
            ...
            try
            {
                ...
                if ((strUserEmail != @"") && IsValidEmail(strUserEmail) && (strMpM != @""))
                {
                    ...
                    if (didItWork.Equals(1))
                    {
                        ...
                        return @"Your API Key is: " + bundleCurrent.APIKey + @"  Your Auth Code is: " + bundleCurrent.Authorization + @" Please close your browser window and clear your internet cache and history after safely storing your API Key and Auth Code.  Contact support@gratitech.com for support.";
                    }
                    else
                    {
        ...
        public static bool IsValidEmail(string email)
        {
            ...
            {
                var con = new SqlConnection("Data Source=.;Integrated Security=SSPI;Initial Catalog=s3cr3tx");//;
                SqlCommand command = new SqlCommand();
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = @"insertLog";
                SqlParameter p1 = new SqlParameter(@"p_Source", @"s3cr3tx_RegexMatchTimeoutValidEmail");
                SqlParameter p2 = new SqlParameter(@"p_logMessage", e.GetBaseException().ToString());
            ...
            {
                SqlConnection con = new SqlConnection("Data Source=.;Integrated Security=SSPI;Initial Catalog=s3cr3tx");//;
                SqlCommand command = new SqlCommand();
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = @"insertLog";
                SqlParameter p1 = new SqlParameter(@"p_Source", @"s3cr3tx_ArgExValidEmail");
                SqlParameter p2 = new SqlParameter(@"p_logMessage", e.GetBaseException().ToString());
                command.Parameters.Add(p1);
                command.Parameters.Add(p2);
                con.Open();
        ...
        private static string GetResult(string strAuth, string strToken, string strEmail, string strInput, bool blnEoD, bool blnDefault)
        {
            try
            {
                ...
                SqlCommand command = new SqlCommand();
                command.CommandText = @"EorD";
                command.CommandType = System.Data.CommandType.StoredProcedure;
                SqlParameter p1 = new SqlParameter(@"p_Auth", strAuth.Trim());
                SqlParameter p2 = new SqlParameter(@"p_APIToken", strToken.Trim());
                SqlParameter p3 = new SqlParameter(@"p_email", strEmail.Trim().ToLower());
                SqlParameter p4 = new SqlParameter(@"p_input", strInput);
                SqlParameter p5 = new SqlParameter(@"p_EorD", blnEoD);
                SqlParameter p6 = new SqlParameter(@"p_blnDefault", blnDefault);
                SqlParameter p7 = new SqlParameter(@"p_strOutput", SqlDbType.NVarChar, -1);
        ...
        { //@"s3cr3tx.api.ValuesController"
            ...
            command.CommandText = @"insertLog";
            command.CommandType = System.Data.CommandType.StoredProcedure;
            SqlParameter p3 = new SqlParameter(@"p_Source", strSource);
            
            SqlParameter p4 = new SqlParameter(@"p_logMessage", strMessage);
            command.Parameters.Add(p3);
            command.Parameters.Add(p4);
            using (sql)
            {
    ...
    public class Bundle
    {
        ...
        public static int storeBundle(Bundle bundleCurrent)
        {
            try
            {
                ...
                SqlCommand command = new SqlCommand();
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = @"InsertM";
                SqlParameter p1 = new SqlParameter(@"p_Guid1", bundleCurrent.Guid1);
                SqlParameter p2 = new SqlParameter(@"p_Guid2", bundleCurrent.Guid2);
                SqlParameter p3 = new SqlParameter(@"p_Email", bundleCurrent.Email);
                SqlParameter p4 = new SqlParameter(@"p_APIKey", bundleCurrent.APIKey);
                SqlParameter p5 = new SqlParameter(@"p_Authorization", bundleCurrent.Authorization);
                SqlParameter p6 = new SqlParameter(@"p_PrivateKey", bundleCurrent.PrivateKey);
                SqlParameter p7 = new SqlParameter(@"p_PublicKey", bundleCurrent.PublicKey);
                SqlParameter p8 = new SqlParameter(@"p_PmHash", bundleCurrent.mPmHash);
                command.Parameters.Add(p1);
                command.Parameters.Add(p2);
                command.Parameters.Add(p3);
                command.Parameters.Add(p4);
            ...
            catch (Exception ex)
            {
                ...
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = @"insertLog";
                SqlParameter p1 = new SqlParameter(@"p_Source", @"s3cr3tx_StoreBundle");
                SqlParameter p2 = new SqlParameter(@"p_logMessage", ex.GetBaseException().ToString());
                command.Parameters.Add(p1);
                command.Parameters.Add(p2);
                con.Open();
                command.Connection = con;
        ...
        public static int Authorize(string Email)
        {
            try
            {
                if (IsValidEmail(Email))
                {
                    ...
                    SqlParameter p1 = new SqlParameter(@"p_IsValid", IsValid);
                    SqlParameter p2 = new SqlParameter(@"p_CreatedBY", strCreated);
                    SqlParameter p3 = new SqlParameter(@"p_Email", Email);
                    SqlParameter p4 = new SqlParameter(@"p_AuthCode", strGuid);
                    command.Parameters.Add(p1);
                    command.Parameters.Add(p2);
                    command.Parameters.Add(p3);
                    command.Parameters.Add(p4);
            ...
            catch (Exception ex)
            {
                ...
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = @"insertLog";
                SqlParameter p1 = new SqlParameter(@"p_Source", @"CreateKeysPKs3cr3tx-Bundle_Authorize");
                SqlParameter p2 = new SqlParameter(@"p_logMessage", ex.GetBaseException().ToString());
                command.Parameters.Add(p1);
                command.Parameters.Add(p2);
                con.Open();
        ...
        public static bool IsValidEmail(string email)
        {
            ...
            catch (RegexMatchTimeoutException e)
            {
                ...
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = @"insertLog";
                SqlParameter p1 = new SqlParameter(@"p_Source", @"s3cr3tx_Console_IsValidEmailRegexMatchTimeout");
                SqlParameter p2 = new SqlParameter(@"p_logMessage", e.GetBaseException().ToString());
                command.Parameters.Add(p1);
                command.Parameters.Add(p2);
                con.Open();
            ...
            catch (ArgumentException e)
            {
                ...
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = @"InsertM";
                SqlParameter p1 = new SqlParameter(@"p_Source", @"s3cr3tx_Console_IsValidEmailArgumentException");
                SqlParameter p2 = new SqlParameter(@"p_logMessage", e.GetBaseException().ToString());
                command.Parameters.Add(p1);
                command.Parameters.Add(p2);
                con.Open();
            ...
            catch (RegexMatchTimeoutException e)
            {
                ...
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = @"insertLog";
                SqlParameter p1 = new SqlParameter(@"p_Source", @"s3cr3tx_Console_IsValidEmail-RegexMatchTimeout");
                SqlParameter p2 = new SqlParameter(@"p_logMessage", e.GetBaseException().ToString());
                command.Parameters.Add(p1);
                command.Parameters.Add(p2);
                con.Open();
        ...
        public static Bundle GetBundle(string Email, string APIKey, string AuthCode)
        {
            try
            {
                ...
                if (IsValidEmail(Email))
                {
                    ...
                    SqlCommand command = new SqlCommand();
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = @"USP_GetBundle_M";
                    SqlParameter p1 = new SqlParameter(@"p_mAuthorization", AuthCode);
                    SqlParameter p2 = new SqlParameter(@"p_mAPIKey", APIKey);
                    SqlParameter p3 = new SqlParameter(@"p_mEmail", Email);
                    command.Parameters.Add(p1);
                    command.Parameters.Add(p2);
                    command.Parameters.Add(p3);
                    con.Open();
            ...
            catch (Exception ex)
            {
                ...
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = @"insertLog";
                SqlParameter p1 = new SqlParameter(@"p_Source", @"s3cr3txConsole_GetBundle");
                SqlParameter p2 = new SqlParameter(@"p_logMessage", ex.GetBaseException().ToString());
                command.Parameters.Add(p1);
                command.Parameters.Add(p2);
                con.Open();
        ...
        public static Bundle GetBundle(string Email)
        {
            try
            {
                ...
                if (IsValidEmail(Email))
                {
                    ...
                    SqlCommand command = new SqlCommand();
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = @"USP_GetBundle_M_Host";
                    ...
                    SqlParameter p2 = new SqlParameter(@"p_mHost", currentHost + @"@" + currentIp + @".org");
                    SqlParameter p3 = new SqlParameter(@"p_mEmail", Email);
                    command.Parameters.Add(p2);
                    command.Parameters.Add(p3);
                    con.Open();
    ...
    public class uspEncDec
    {
        ...
        public static string EncDec(string email, string input, bool EorD, bool blnDefault, out string strText) //, out string text)
        {
            try
            {
                ...
                if (blnDefault)
                {
                    ebundle eb = ebundle.GetEbundle(@"support@gratitech.com");
            ...
            {
                using (SqlConnection con = new SqlConnection("Data Source=.;Integrated Security=SSPI;Initial Catalog=s3cr3tx"))//)
                {
                    ...
                    using (SqlCommand command = new SqlCommand())
                    {
                        command.CommandText = @"insertLog";
                        command.CommandType = CommandType.StoredProcedure;
                        SqlParameter p1 = new SqlParameter(@"p_source", @"EncDec_Sproc");
                        SqlParameter p2 = new SqlParameter(@"p_logMessage", ex.GetBaseException().ToString());
                        con.Open();
                        command.Connection = con;
                        command.Parameters.Add(p1);
            ...
            catch (Exception ex)
            {
                using (SqlConnection con = new SqlConnection("Data Source=.;Integrated Security=SSPI;Initial Catalog=s3cr3tx"))//)
                {
                    ...
                    using (SqlCommand command = new SqlCommand())
                    {
                        command.CommandText = @"insertLog";
                        command.CommandType = CommandType.StoredProcedure;
                        SqlParameter p1 = new SqlParameter(@"p_source", @"Enc_Sproc");
                        SqlParameter p2 = new SqlParameter(@"p_logMessage", ex.GetBaseException().ToString());
                        con.Open();
                        command.Connection = con;
                        command.Parameters.Add(p1);
        ...
        public static string Enc3(string email, string input) //, out string text)
        {
            try
            {
                string result = @"";
        ...
        public static string Enc1(string email, string input) //, out string text)
        {
            try
            {
                string result = @"";
        ...
        public static string Dec3(string email, string input) //, out string text)
        {
            try
            {
                string result = @"";
            ...
            catch (Exception ex)
            {
                using (SqlConnection con = new SqlConnection("Data Source=.;Integrated Security=SSPI;Initial Catalog=s3cr3tx")) //)
                {
                    ...
                    using (SqlCommand command = new SqlCommand())
                    {
                        command.CommandText = @"insertLog";
                        command.CommandType = CommandType.StoredProcedure;
                        SqlParameter p1 = new SqlParameter(@"p_source", @"Dec_Sproc");
                        SqlParameter p2 = new SqlParameter(@"p_logMessage", ex.GetBaseException().ToString());
                        con.Open();
                        command.Connection = con;
                        command.Parameters.Add(p1);
        ...
        public static string Dec1(string email, string input) //, out string text)
            {
                try
                {
                    string result = @"";
    ...
    class ebundle
    {
        ...
        public static ebundle GetEbundle(string email)
        {
                using (SqlConnection con = new SqlConnection("Data Source=.;Integrated Security=SSPI;Initial Catalog=s3cr3tx"))//)
                {
                    //string strConnection = "Data Source=.;Integrated Security=SSPI;Initial Catalog=s3cr3tx"; // = "Server=localhost;Database=S;User Id=sa;Password=Sunsh1n3-20p;";
                    //SqlConnection con = new SqlConnection("Data Source=.;Integrated Security=SSPI;Initial Catalog=s3cr3tx");//
                    using (SqlCommand command = new SqlCommand())
                    {
                        command.CommandText = @"getBundle";
                        command.CommandType = CommandType.StoredProcedure;
                        SqlParameter p1 = new SqlParameter(@"p_email", email);
                        con.Open();
                        command.Connection = con;
                        command.Parameters.Add(p1);
                        DataSet ds = new DataSet();
