...
namespace s3cr3txMVC.Controllers
{
    ...
    public class UploadController : ControllerBase
    {
        ...
        { //@"s3cr3tx.api.ValuesController"
            string strConnection = "Server=127.0.0.1; Port=3306; User ID=root; Password=password1234; Database=s3cr3tx"; // = @"Data Source=.;User Id=sa;Password=yourStrong!Password;Initial Catalog=s3cr3tx";
            MySqlConnection sql = new MySqlConnection("Server=127.0.0.1; Port=3306; User ID=root; Password=password1234; Database=s3cr3tx");//
